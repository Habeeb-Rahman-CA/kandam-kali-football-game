...
func perform_ai_decisions() -> void:
	...
	if ball.carrier == player:
		...
		elif randf() < PASS_PROBABILITY and has_opponent_nearby() and has_teammate_in_view():
...
func has_teammate_in_view() -> bool:
	...
	return player_in_view.find_custom(func(p: Player): return p != player and p.club == player.club) > -1
